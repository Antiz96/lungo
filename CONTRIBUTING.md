...
Thank you for considering contributing to [lungo](https://github.com/Antiz96/lungo)!
...
**Note:** To report security concerns, please follow the instructions in the [SECURITY.md](https://github.com/Antiz96/lungo/blob/main/SECURITY.md) document.

Before [opening an issue](https://github.com/Antiz96/lungo/issues/new/choose), verify that there isn't one already open on the same (or a similar) subject.
...
Make sure to create your merge request from a dedicated branch (do not use the `main` branch) and to provide the information requested in the [pull request template](https://github.com/Antiz96/lungo/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
By contributing to this project, you agree that your contributions will be licensed under the [GPL-3.0 license](https://github.com/Antiz96/lungo/blob/main/LICENSE) (or any later version of this license).
...
Once again, thank you for considering contributing to lungo!  
I'd also like to sincerely thank everyone that gave lungo a star, opened issues, feature requests, pull requests or contributed to this project in any other way! :heart:
