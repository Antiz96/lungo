...
This project is generally inspired by [caffeine](https://launchpad.net/caffeine) / [caffeine-ng](https://codeberg.org/WhyNotHugo/caffeine-ng) (hence the [lungo](https://en.wikipedia.org/wiki/Lungo) name, as a reference) with a specific part of the implementation adapted from [caffeine-applet](https://github.com/codevardhan/caffeine-applet) (see the [THIRD-PARTY-NOTICES.md file](https://github.com/Antiz96/lungo/blob/main/THIRD-PARTY-NOTICES.md) for details).
